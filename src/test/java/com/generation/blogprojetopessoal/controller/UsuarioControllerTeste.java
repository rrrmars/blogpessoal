package com.generation.blogprojetopessoal.controller;
...
import com.generation.blogprojetopessoal.model.UsuarioLogin;
import com.generation.blogprojetopessoal.model.Usuario;
import com.generation.blogprojetopessoal.repository.UsuarioRepository;
import com.generation.blogprojetopessoal.service.UsuarioService;
...
public class UsuarioControllerTeste {
	...
	public void deveAtualizarUmUsuario() {
		...
		//atualizando o usuário criado anteriormente
		Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), 
			"Juliana Andrews Ramos", "juliana_ramos@email.com.br", 
			"juliana123", "https://i.imgur.com/yDRVeK7.jpg");
		
		//encamihando a atualização
